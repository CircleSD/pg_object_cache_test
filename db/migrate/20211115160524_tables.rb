class Tables < ActiveRecord::Migration[6.1]
  ...
  def change
    3000.times do |index|
      # reset pg connection
      # ActiveRecord::Base.connection.reconnect! if index % 50 == 0
      # create Postgres schema and set the search path so we use it
      ...
      # populate the new schema with our Rails application's table schema
      create_schema
    end
  end
